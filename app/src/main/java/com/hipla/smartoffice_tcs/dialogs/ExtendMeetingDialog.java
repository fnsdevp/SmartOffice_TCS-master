...
import com.hipla.smartoffice_tcs.databinding.DialogFragmentExtendMeetingBinding;
 ...
 */
public class ExtendMeetingDialog extends android.support.v4.app.DialogFragment implements SelectContactFragment.OnContactSelected, WeekListAdapter.OnDateClickListener, StringRequestListener, TimeSlotAdapter.OnTimeSlotClickListener, DatePickerDialog.OnDateSetListener {
    ...
    public void getAvailableRooms(String date) {
        ...
        if (selectedContact != null) {
            ...
            new PostStringRequest(getActivity(), requestParameter, ExtendMeetingDialog.this, "getAvailableRooms",
